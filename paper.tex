...
The random error was inferred from the sample standard deviation and the
systematic error from the sensor calibrations or datasheets. Combining both
sources of error, along with their propagation into quantities derived from
multiple measurements, followed the procedures outlined in Coleman and Steele
(2009) \cite{ColemanSteele}, described below.
