...
at a turbine diameter Reynolds number $Re_D \approx 10^6$. The effects of blade
...
drastically reduced the rotor power coefficient. Strut drag was also measured
for the NACA 0021 and cylindrical configurations with the blades removed. An
optimal tip speed ratio $\lambda_0 = 3.1$ was chosen, at which the near wake
velocity was measured at 1 m $(x/D=0.93)$ downstream. Mean velocity, turbulence
kinetic energy, and mean kinetic energy transport were compared with results
from a high solidity turbine acquired with the same test apparatus. Overall,
lower levels of streamwise wake recovery were calculated for the RM2 case---a
...
and a slightly blockage ratio \cite{Bachant2015-JoT}. Tip vortex shedding is
...
cross-flow turbine was measured in a towing tank.
...
terms at this location. It is interesting to note that though the RM2 is a more
effective energy converter than the UNH-RVAT, its wake recovery may in fact be
delayed due to weaker blade tip vortex shedding and lower levels of turbulence
in the near-wake.
